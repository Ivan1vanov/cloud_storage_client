...
import { AuthInputComponent, SwitchAuthOptionComponent, SignInPageComponent } from '../../../../app/modules';
...
describe('SignInPageComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [SignInPageComponent, AuthInputComponent, MapErrorMessagesComponent, SwitchAuthOptionComponent, AppButtonComponent],
  ...
  describe('onSubmit', () => {
    it('should handle login request', async () => {
      ...
      authServiceSpy.login.and.resolveTo(observableMock);
    
      await component.onSubmit();
  
      expect(authServiceSpy.login).toHaveBeenCalledWith(component.formData);
